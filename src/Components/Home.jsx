...
function Home() {
  ...
  const resumeUrl = "https://drive.google.com/file/d/16YMaiyTW763VxIzwxKSqhwu28ZvRli7d/view?usp=sharing";
    ...
    <section id="home">
      ...
      <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        <div className="mr-auto place-self-center lg:col-span-7">
          ...
          <p className="bg-black lg:max-w-2xl mb-6 text-justify lg:mb-8 md:text-lg lg:text-xl text-gray-400 font-semibold">
